...
vscode_marketplace: "https://marketplace.visualstudio.com/items?itemName=ShanjidArefin.c-through"
vsix_openvsx: "https://open-vsx.org/extension/ShanjidArefin/c-through"
...
| v2.2.4 | Dead Code Report panel — unused functions, globals, macros, unresolved externs |
| v2.2.9 | Added Call Graph toolbar button responsiveness, Function detection with macro-prefixed return types  |
...
Search **C Through** in the VS Code Extensions panel, or get it directly:

| Platform | Link |
|---|---|
| VS Code Marketplace | [Install from Marketplace](https://marketplace.visualstudio.com/items?itemName=ShanjidArefin.c-through) |
| Open VSX Registry | [Install from Open VSX](https://open-vsx.org/extension/ShanjidArefin/c-through) |
| GitHub Releases | [Download latest .vsix](https://github.com/ShihabKuet/c-through/releases/latest) |

Or install via terminal:

```bash
code --install-extension c-through-2.2.9.vsix
```
