  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center">
        ...
        {/* Status badge */}
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-zinc-200 dark:border-zinc-700/50 bg-white/80 dark:bg-zinc-900/50 text-zinc-500 dark:text-zinc-400 text-sm mb-8 backdrop-blur-sm">
        ...
        {/* Headline */}
        <motion.h1 {...fadeUp} transition={{ duration: 0.6, delay: 0.2 }} className="text-5xl sm:text-6xl md:text-7xl font-bold text-zinc-900 dark:text-zinc-100 leading-tight mb-4">
          Hi, I&apos;m{" "}
        ...
        {/* Bio */}
        <motion.p {...fadeUp} transition={{ duration: 0.6, delay: 0.35 }} className="text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto mb-8 leading-relaxed">
          {personalInfo.bio}
        </motion.p>
        ...
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.55 }} className="flex flex-wrap items-center justify-center gap-3 mb-12">
          ...
          <a href="#contact" className="px-6 py-3 border border-zinc-300 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-500 text-zinc-700 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-zinc-100 font-medium rounded-lg transition-all duration-200 hover:bg-zinc-100 dark:hover:bg-zinc-800/50 hover:-translate-y-0.5">
            Get In Touch
          </a>
        </motion.div>
